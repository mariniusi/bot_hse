...
#вводим самого бота
bot = telebot.TeleBot('6984747477:AAF8x2-WZm6vs0N9a2UktMWj3JkkhiYfPp0')
...
def summa(message):
    ...
    bot.send_message(message.from_user.id, 'Введите сумму (числом) в той валюте, которую хотите перевести 🤑')
